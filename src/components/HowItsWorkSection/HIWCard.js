const HIWCard = (props) => {
  return (
    <li className={`${props.className} flex justify-between items-center`}>
      <div className="flex justify-center items-center w-[15%] lg:w-[40%]">
      ...
      <div className="flex flex-col justify-center items-center w-[65%] lg:w-[40%]">
        <p
          className={`${props.classNameTitle} text-[#333333] font-bold text-[28px] my-1 text-left w-full lg:w-[70%]`}
        >
          {props.title}
        </p>
        <p
          className={`${props.classNameDesc} text-[#333333] text-[16px] lg:text-[18px] w-full lg:w-[70%] my-1`}
        >
          {props.description}
        </p>
      </div>
