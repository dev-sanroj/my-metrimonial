    ...
    <section className="flex justify-center items-center w-[100%] bg-[#FFF9F0] py-10">
      <div className="flex flex-col justify-center items-center w-[90%]">
        <div className="relative flex justify-center items-center min-h-[300px] w-[100%]">
          <span className="absolute font-black text-[140px] text-[#FFF0EA] z-10">
            Logo
          </span>
          <div className="relative flex flex-col justify-center items-center z-10">
            <img src={icon} alt="" className="opacity-[0.4]" />
            <p className="text-[#333333] font-bold text-[52px]">
              Why choose us
            </p>
            <p className="text-[#818181] font-semibold text-[24px] mt-2 tracking-wider">
              Most Trusted and premium Matrimony Service in the World.
            </p>
          </div>
        </div>
        <ul className="flex justify-around items-center min-h-[300px] w-[100%]">
          <li className="flex flex-col justify-center items-center bg-[#FFE8E5] rounded-lg w-[350px] h-[265px] py-10 px-6 shadow-[0_0_8px_0px_rgba(0,0,0,0.1)]">
