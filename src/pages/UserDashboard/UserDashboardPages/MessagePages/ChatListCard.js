  ...
  return (
    ...
    >
      <div className="flex justify-center items-center">
        <div className="flex justify-center items-center rounded-full mr-3 w-[90px] h-[90px] md:w-[110px] md:h-[110px] overflow-hidden bg-[#f7f7f7] shadow-[0_0_8px_rgba(0,0,0,0.1)] relative">
          <img
            src={props.imageSrc}
            alt="picprofile"
